...
public class FindDistinctEvents {
    ...
    /**
     * Discards duplicate click events from the input stream by title
     * <p>
     * Duplicate records are detected based on title
     * The transformer remembers known titles within an associated window state
    ...
    private static class DeduplicationTransformer<K, V, E> implements ValueTransformerWithKey<K, V, V> {
        ...
        /**
         * @param maintainDurationPerEventInMs how long to "remember" a known title
    ...
    private SpecificAvroSerde<ActingEvent> buildClicksSerde(final Properties allProps) {
        final SpecificAvroSerde<ActingEvent> serde = new SpecificAvroSerde<>();
    ...
    public Topology buildTopology(Properties allProps,
                                  final SpecificAvroSerde<ActingEvent> clicksSerde) {
        ...
        builder
                ...
                .transformValues(() -> new DeduplicationTransformer<>(windowSize.toMillis(), (key, value) -> value.getTitle()), storeName)
                .filter((k, v) -> v != null)
